    ...
    <div class="col-lg-10 offset-lg-1">
        <div class="card">
            <div class="card-body product-info">
                <div class="row">
                    <div class="col-5 text-center" style="border: solid 1px #eee;">
                    ...
                    <div class="col-7">
                        ...
                        @else
                            ...
                            <div class="sales_and_reviews">
                                ...
                                <div class="sold_count">累计评价 <span class="count">{{ $product->review_count }}</span></div>
                        ...
                        <div class="buttons">
                            ...
                            @if($product->type === \App\Models\Product::TYPE_CROWDFUNDING)
                                @if(Auth::check())
                                    ...
                                    @endif
                                @else
                                    <a class="btn btn-primary" href="{{ route('login') }}">前先登录</a>
                                @endif
                            @else
