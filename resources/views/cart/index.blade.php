        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th><label><input type="checkbox" id="select-all">&nbsp;<small>全选</small></label></th>
                        <th>商品信息</th>
                        <th>单价</th>
                        <th>数量</th>
                        <th>操作</th>
                        ...
                        <tr data-id="{{ $item->productSku->id }}">
                            ...
                            <td>
                                <input type="text" class="form-control form-control-sm amount" name="amount"
                                    value="{{ $item->amount }}" @if(! $item->productSku->product->on_sale) disabled @endif>
                            </td>
                            <td>
...
<script>
    $(document).ready(function () {
        ...
        $('#select-all').change(function () {
            // 获取当选框的选中状态
            // prop() 方法可以知道标签中是否包含某个属性，当单选框被勾选，对应的标签就会新增一个 checked 的属性
